            ...
            <section className="bg-white py-4 px-8 mb-4 rounded-lg w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8">
                <div className="flex flex-col mb-2">
                  ...
                  <input type="text" name="name" id="name" className="p-2.5 bg-emerald-50 rounded-lg text-sm border-2 border-emerald-300 hover:bg-white hover:border-emerald-400 focus:outline-none focus:bg-white" required/>
                </div>
                <div className="flex flex-col mb-2">
                  <label htmlFor="email" className="font-medium">Email</label>
                  <input type="email" name="email" id="email" className="p-2.5 bg-emerald-50 rounded-lg text-sm border-2 border-emerald-300 opacity-75" disabled/>
                </div>
                <div className="flex flex-col mb-2">
                  <label htmlFor="weight" className="font-medium">Berat badan (kg)</label>
                  <input type="number" name="weight" id="weight" className="p-2.5 bg-emerald-50 rounded-lg text-sm border-2 border-emerald-300 hover:bg-white hover:border-emerald-400 focus:outline-none focus:bg-white" required/>
                </div>
                <div className="flex flex-col mb-2">
                  <label htmlFor="height" className="font-medium">Tinggi badan (cm)</label>
                  <input type="number" name="height" id="height" className="p-2.5 bg-emerald-50 rounded-lg text-sm border-2 border-emerald-300 hover:bg-white hover:border-emerald-400 focus:outline-none focus:bg-white" required/>
                </div>
                <div className="flex flex-col mb-2">
                  <label htmlFor="birthday" className="font-medium">Tanggal lahir</label>
                  <input type="date" name="birthday" id="birthday" className="p-2.5 bg-emerald-50 rounded-lg text-sm border-2 border-emerald-300 hover:bg-white hover:border-emerald-400 focus:outline-none focus:bg-white" required/>
                </div>
                <div className="flex flex-col mb-2">
                  <label htmlFor="gender" className="font-medium">Jenis kelamin</label>
                  <select name="gender" id="gender" className="p-2.5 bg-emerald-50 rounded-lg text-sm border-2 border-emerald-300 hover:bg-white hover:border-emerald-400 focus:outline-none focus:bg-white" required>
                ...
                <div className="flex flex-col mb-2">
                  ...
                  <select name="activity_level" id="activity_level" className="p-2.5 bg-emerald-50 rounded-lg text-sm border-2 border-emerald-300 hover:bg-white hover:border-emerald-400 focus:outline-none focus:bg-white" required>
