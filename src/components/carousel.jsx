...
function Carousel() {
  return (
    <section className="max-w-screen-xl py-4 lg:gap-8 xl:gap-0 overflow-hidden">
      <div className="relative grid grid-cols-2">
        <div></div>
        <svg viewBox="0 0 567 591" xmlns="http://www.w3.org/2000/svg" className="invisible lg:visible carousel-color w-full aspect-[4/3] mx-auto fill-emerald-400">
        ...
        <div className="carousel w-[300%] flex absolute top-0 left-0 h-full">
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <img src={carouselImg1} alt="image" className="hidden lg:block w-full aspect-[3/2] mt-auto mb-0"/>
          </div>
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="place-self-center text-center sm:max-w-screen-sm lg:text-start">
