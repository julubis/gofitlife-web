  ...
  <nav className="bg-white fixed w-full z-20 top-0 start-0 backdrop-filter backdrop-blur-lg bg-opacity-80">
    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div className={`flex md:order-2 space-x-3 md:space-x-0 ${ hidden ? 'hidden' : '' }`}>
        ...
        <button data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-emerald-100 focus:outline-none focus:ring-2 focus:ring-emerald-200" aria-label="Open Navbar" onClick={() => setOpenNav(nav => !nav)}>
