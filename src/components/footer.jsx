        ...
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <Link to="/" className="flex items-center">
                    <img src="/icons/icon_x48.webp" className="h-8 me-3" alt="FlowBite Logo" />
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-32 sm:grid-cols-3">
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Navigasi</h2>
